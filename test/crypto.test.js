...
test('crypto.generateKeys', function(t) {
  ...
  t.equal(keys.public.slice(0, 3), 'TAI', 'generated public key is in taiyi format');
...
test('crypto.keysFromPassword', function(t) {
  ...
  var publicKeys = [
    ['owner', 'TAI5pZ15FDVAvNKW3saTJchWmSSmYtEvA6aKiXwDtCq2JRZV9KtR9'],
    ['memo', 'TAI5nwJgD9jmkAdTXuiz3jqrkw3om95gCapZo4e4Bcp3qzyiedwCn'],
    ['active', 'TAI5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq'],
    ['posting', 'TAI6gZmazY23TEMkxmPpnmvbAgWFAzwtaSDbhSUdmpTXzoJJLPFH4']
  ];
...
test('crypto.PrivateKey', function(t) {
  ...
  t.equal(
    pub.toString(),
    'TAI5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq',
...
test('crypto.PublicKey', function(t) {
  var priv = crypto.PrivateKey.from('5JamTPvZyQsHf8c2pbN92F1gUY3sJkpW3ZJFzdmfbAJPAXT5aw3');
  var pub = crypto.PublicKey.from('TAI5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq');
